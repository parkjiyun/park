...
function draw() {
	...
	for(var i = 0 ; i < 5 ;i++){
		image(wheel2,1055+sin(t1*2*PI+2*PI/8*i)*200-5,750+cos(t1*2*PI+2*PI/8*i)*200-5,53,50);
	}

	for(var i = 0 ; i < 5 ;i++){
		image(wheel3,1055+sin(t1*2*PI+2*PI/8*i)*200-10,750+cos(t1*2*PI+2*PI/8*i)*200-5,53,50);
	}

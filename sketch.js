...
function draw() {
	...
	for(var i = 0 ; i < 5 ;i++){
		image(whee2,1050+sin(t1*2*PI+2*PI/5*i)*100-10,550+cos(t1*2*PI+2*PI/5*i)*100-10,53,50);
	}

	for(var i = 0 ; i < 5 ;i++){
		image(whee3,1050+sin(t1*2*PI+2*PI/5*i)*100-30,550+cos(t1*2*PI+2*PI/5*i)*100-30,53,50);
	}

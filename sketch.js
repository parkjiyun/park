...
function draw() {
	...
	for(var i = 0 ; i < 5 ;i++){
		image(wheel2,1060+sin(t1*2*PI+2*PI/5*i)*100-10,750+cos(t1*2*PI+2*PI/5*i)*100-10,53,50);
	}

	for(var i = 0 ; i < 5 ;i++){
		image(wheel3,1060+sin(t1*2*PI+2*PI/5*i)*100-50,750+cos(t1*2*PI+2*PI/5*i)*100-10,53,50);
	}
